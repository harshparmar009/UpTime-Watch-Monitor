...
import styles from './CreateMonitorDrawer.module.css';
...
export default function CreateMonitorDrawer({ open, onClose, onCreated }) {
      ...
      <div className={`${styles.drawer} ${open ? styles.drawerOpen : ''}`}>
        <div className={styles.drawerHeader}>
          <div className={styles.drawerTitle}>
            <div className={styles.drawerIcon}><Globe size={15} /></div>
          ...
          <form onSubmit={handleSubmit} className={styles.form}>
            <div className={styles.field}>
              ...
              <input
                ...
                autoFocus={open}
              />
              <p className={styles.hint}>A friendly name to identify this monitor</p>
            </div>
